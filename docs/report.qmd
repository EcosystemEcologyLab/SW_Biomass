...
#| fig-align: center
include_graphics(tar_read(agb_map_az_png) |> fs::path_rel("docs"))
```
...
#| fig-align: center
include_graphics(tar_read(agb_map_ca_png) |> fs::path_rel("docs"))
```
...
include_graphics(tar_read(agb_map_srer_png) |> fs::path_rel("docs"))
```
...
include_graphics(tar_read(agb_map_pima_png) |> fs::path_rel("docs"))
```
...
include_graphics(tar_read(median_map_az_png) |> fs::path_rel("docs")) 
```
...
include_graphics(tar_read(median_map_ca_png) |> fs::path_rel("docs"))
```
...
include_graphics(tar_read(median_map_srer_png) |> fs::path_rel("docs"))
```
...
include_graphics(tar_read(median_map_pima_png) |> fs::path_rel("docs"))
```
...
include_graphics(tar_read(sd_map_az_png) |> fs::path_rel("docs"))
```
...
include_graphics(tar_read(sd_map_ca_png) |> fs::path_rel("docs"))
```
...
include_graphics(tar_read(sd_map_srer_png) |> fs::path_rel("docs"))
```
...
include_graphics(tar_read(sd_map_pima_png) |> fs::path_rel("docs"))
```
...
include_graphics(tar_read(ridge_az_png) |> fs::path_rel("docs"))
```
...
include_graphics(tar_read(ridge_ca_png) |> fs::path_rel("docs"))
```
...
include_graphics(tar_read(ridge_srer_png) |> fs::path_rel("docs"))
```
...
include_graphics(tar_read(ridge_pima_png) |> fs::path_rel("docs"))
```
...
include_graphics(tar_read(scatter_plots) |> fs::path_rel("docs"))
```
