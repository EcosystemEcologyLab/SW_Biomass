...
@fig-map_agb shows all of the data products transformed to the same extent and resolution.
@fig-map_median shows the median AGB across all products.
@fig-map_sd shows spatial distribution of uncertainty.
