...
#| fig-align: center
include_graphics(here(tar_read(agb_map_az_png)))
```
...
#| fig-align: center
include_graphics(here(tar_read(agb_map_ca_png)))
```
...
include_graphics(here(tar_read(agb_map_srer_png)))
```
...
include_graphics(here(tar_read(agb_map_pima_png)))
```
...
include_graphics(here(tar_read(median_map_az_png)))
```
...
include_graphics(here(tar_read(median_map_ca_png)))
```
...
include_graphics(here(tar_read(median_map_srer_png)))
```
...
include_graphics(here(tar_read(median_map_pima_png)))
```
...
include_graphics(here(tar_read(sd_map_az_png)))
```
...
include_graphics(here(tar_read(sd_map_ca_png)))
```
...
include_graphics(here(tar_read(sd_map_srer_png)))
```
...
include_graphics(here(tar_read(sd_map_pima_png)))
```
...
include_graphics(here(tar_read(ridge_az_png)))
```
...
include_graphics(here(tar_read(ridge_ca_png)))
```
...
include_graphics(here(tar_read(ridge_srer_png)))
```
...
include_graphics(here(tar_read(ridge_pima_png)))
```
...
include_graphics(here(tar_read(scatter_plots)))
```
