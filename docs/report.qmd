...
![Distribution of Arizona AGB values by data product. Axis is "broken" omitting values between 20 and 100 for AGB.](fig/agb_density_az.png){#fig-ridge1 fig-align="center" width="5in"}

<!-- {{< downloadthis fig/agb_density_az.png label="Download .png" >}} -->

![Distribution of Arizona AGB values by data product. Axis is "broken" omitting values between 20 and 100 for AGB. Kernel density estimation is performed separately for each panel.](fig/agb_density2_az.png){#fig-ridge2 fig-align="center" width="5in"}

<!-- {{< downloadthis fig/agb_density2_az.png label="Download .png" >}} -->
